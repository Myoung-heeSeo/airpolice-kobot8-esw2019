...
import {WiCloud, WiHumidity, WiDust} from 'react-icons/wi';
...
class Roomgraph extends Component {
  ...
  render() {
    ...
    const data2 = [      
      {name: 9, pm10: 15, pm25: 8.9, amt: 2220},
      {name: 10, pm10: 14.1, pm25: 9.4, amt: 2220},
      {name: 11, pm10: 12.3, pm25: 9.6, amt: 2220},
      {name: 12, pm10: 14.1, pm25: 10.6, amt: 2220},
      {name: 13, pm10: 12.4, pm25: 10.8, amt: 2220},
      {name: 14, pm10: 12.1, pm25: 9.9, amt: 2220},
      {name: 15, pm10: 12.9, pm25: 9.8, amt: 2220},
      {name: 16, pm10: 16.5, pm25: 9.9, amt: 2220},
      {name: 17, pm10: 15.8, pm25: 9.6, amt: 2220},
      {name: 18, pm10: 14.8, pm25: 9.3, amt: 2220},
      {name: 19, pm10: 14.1, pm25: 10.0, amt: 2220},
      {name: 20, pm10: 13.3, pm25: 10.0, amt: 2220},
    ];

    const data3 = [      
      {name: 9, pm10: 13.2, pm25: 8.9, amt: 2220},
      {name: 10, pm10: 11.1, pm25: 9.4, amt: 2220},
      {name: 11, pm10: 12.3, pm25: 9.6, amt: 2220},
      {name: 12, pm10: 11.1, pm25: 8.6, amt: 2220},
      {name: 13, pm10: 12.4, pm25: 9.8, amt: 2220},
      {name: 14, pm10: 14.5, pm25: 9.3, amt: 2220},
      {name: 15, pm10: 12.9, pm25: 8.8, amt: 2220},
      {name: 16, pm10: 13.5, pm25: 8.9, amt: 2220},
      {name: 17, pm10: 12.8, pm25: 9.2, amt: 2220},
      {name: 18, pm10: 12.8, pm25: 9.9, amt: 2220},
      {name: 19, pm10: 12.4, pm25: 10.0, amt: 2220},
      {name: 20, pm10: 13.3, pm25: 9.5, amt: 2220},
    ];
        ...
        <div>
            ...
            <Row className="Roomgraph">
                <IconContext.Provider value={{ style: { verticalAlign: 'middle' }, size: "6em" }}>
                    ...
                    <Col className="center">
                        <IconButton iconComponent={WiHumidity} onClick={() => this.onRadioBtnClick(2)} active={this.state.rSelected === 2}></IconButton>
                    </Col>
                    <Col className="center">
                        <IconButton iconComponent={WiDust}  onClick={() => this.onRadioBtnClick(3)} active={this.state.rSelected === 3}></IconButton>
                    </Col>
